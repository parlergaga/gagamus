const motsGaga = [
    ...
    "debeloise", "debigoiser", "debringué", "decubasser", "defiferlé",
    "degobiller", "degoiser", "degrener", "deguiller", "depenaillé", "deprofiter", "des-fois", "dîner", "ebarioles",
    "ebarliaudes", "ebouillé", "ebravager", "ecorpelé", "egrointer", "emaseler", "encaqué", "equevilles",
    "evanlé", "faramelan", "fayard", "fenêtron","fiarde", "flique", "fouilla", "fourme", "franc", "fricaude",
    "gabelou", "galandage", "galapiat", "gambelle", "gambinotte", "gandou", "gandouze", "gapiand", "garagnas", "gâté",
    ...
    "matefaim", "matru", "mazanter", "miladzeu", "milapiat", "minater", "à un de ces moments", "moulachique",
